...
describe('UsbDevicePipeJsFunctionsTest', function () {
    ...
    it('claim_interface_test_01', 0, function () {
        ...
        for (var j = 0; j < g_DeviceList[0].configs.length; j++) {
            ...
            for (var k = 0; k < g_DeviceList[0].configs[j].interfaces.length; k++) {
                var isClaim = usb.claimInterface(g_Pipe, g_DeviceList[0].configs[j].interfaces[k], true)
                console.info('usb case claimInterface function return: ' + isClaim);
                expect(isClaim).assertEqual(0);
                if (isClaim == 0) {
                    isClaim = usb.releaseInterface(g_Pipe, g_DeviceList[0].configs[j].interfaces[k])
    ...
    */
    it('set_configuration_test_01', 0, function () {
        ...
        for (var j = 0; j < g_DeviceList[0].configs.length; j++) {
            var ret = usb.setConfiguration(g_Pipe, g_DeviceList[0].configs[j])
    ...
    */
    it('set_configuration_test_02', 0, function () {
        ...
        for (var j = 0; j < g_DeviceList[0].configs.length; j++) {
            var config = JSON.parse(JSON.stringify(g_DeviceList[0].configs[j]));
            config.id = 255
    ...
    */
    it('set_interface_test_01', 0, function () {
        ...
        for (var j = 0; j < g_DeviceList[0].configs.length; j++) {
            ...
            expect(isClaim).assertEqual(0)
            if (isClaim == 0) {
                var ret = usb.setInterface(g_Pipe, g_DeviceList[0].configs[j].interfaces[0])
                expect(ret).assertEqual(0);
    ...
    */
    it('set_interface_test_02', 0, function () {
        ...
        for (var j = 0; j < g_DeviceList[0].configs.length; j++) {
            ...
            expect(isClaim).assertEqual(0)
            if (isClaim == 0) {
                var tmpInterface = JSON.parse(JSON.stringify(g_DeviceList[0].configs[j].interfaces[0]));
                tmpInterface.id = 234
