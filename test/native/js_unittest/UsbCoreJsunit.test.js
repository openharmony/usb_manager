...
describe('UsbCoreJsFunctionsTest', function () {
    ...
    */
    it('get_devices_test_01', 0, function () {
        ...
        expect(g_DeviceList.length).assertLarger(0);
        console.info('usb case getDevices ret length: ' + g_DeviceList.length);
    ...
    */
    it('has_right_01', 0, function () {
        ...
        for (var i = 0; i < g_DeviceList.length; i++) {
            var hasRight = usb.hasRight(g_DeviceList[i].name)
    ...
    */
    it('request_right_01', 0, function () {
        ...
        for (var i = 0; i < g_DeviceList.length; i++) {
            usb.requestRight(g_DeviceList[i].name).then(hasRight => {
                expect(hasRight).assertTrue();
                console.info('usb request_right ret :' + hasRight);
                console.info('usb request_right_01 :  PASS');
            }).catch(error => {
                console.info('usb case device request right failed : ' + error + ' :' + g_DeviceList[i].name);
                expect(false).assertTrue();
            });
        }
    })
    ...
    */
    it('connect_device_01', 0, function () {
        ...
        console.info('usb case connectDevice ret: ' + JSON.stringify(g_Pipe));
        expect(CheckEmptyUtils.isEmpty(g_Pipe)).assertFalse();
    ...
    */
    it('close_pipe_02', 0, function () {
        ...
        var tmpPipe = JSON.parse(JSON.stringify(g_Pipe));
        tmpPipe.busNum = -23
    ...
    */
    it('close_pipe_01', 0, function () {
        ...
        console.info('usb case closePipe param: ' + JSON.stringify(g_Pipe));
