...
describe('UsbDevicePipeJsFunctionsTestEx', function () {
    ...
    beforeAll(function () {
        ...
        g_Pipe = usb.connectDevice(g_DeviceList[0])
        console.info('usb unit connectDevice g_Pipe ret : ' + JSON.stringify(g_Pipe));
    })
    beforeEach(function () {
    ...
    afterAll(function () {
        var isPipClose = usb.closePipe(g_Pipe)
        console.info('usb unit close g_Pipe ret : ' + isPipClose);
    ...
    function getTransferTestParam() {
        ...
        console.info('usb case g_DeviceList.length: ' + g_DeviceList.length);
        for (var i = 0; i < g_DeviceList.length; i++) {
            testParam.device = g_DeviceList[i]
            testParam.config = testParam.device.configs[0]
            testParam.pip = g_Pipe
            InitPoint(testParam)
        }
        return testParam
    }
    ...
    */
    it('bulk_transfer_test_03', 0, function () {
        ...
        testParam.sendData = 'send time 13213213 wzy';
    ...
    */
    it('bulk_transfer_test_04', 0, function () {
    ...
    */
    it('bulk_transfer_test_05', 0, function () {
    ...
    */
    it('claim_interface_test_02', 0, function () {
        ...
        if (g_DeviceList[0].configs.length == 0) {
            console.info('usb case current device.configs.length = 0');
            expect(false).assertTrue();
            return
        }

        for (var j = 0; j < g_DeviceList[0].configs.length; j++) {
            if (g_DeviceList[0].configs[j].interfaces.length == 0) {
                console.info('usb case current device.configs.interfaces.length = 0');
            }
            for (var k = 0; k < g_DeviceList[0].configs[j].interfaces.length; k++) {
                var TmpInterface = g_DeviceList[0].configs[j].interfaces[k]
                TmpInterface.id = 123
                var isClaim = usb.claimInterface(g_Pipe, TmpInterface, true)
    ...
    */
    it('claim_interface_test_03', 0, function () {
    ...
    */
    it('claim_interface_test_04', 0, function () {
    ...
    */
    it('claim_interface_test_05', 0, function () {
    ...
    */
    it('claim_interface_test_06', 0, function () {
    ...
    */
    it('release_interface_test_01', 0, function () {
        ...
        for (var j = 0; j < g_DeviceList[0].configs.length; j++) {
            ...
            for (var k = 0; k < g_DeviceList[0].configs[j].interfaces.length; k++) {
                var tmpInterface = g_DeviceList[0].configs[j].interfaces[k]
                tmpInterface.id = 134
                var isClaim = usb.releaseInterface(g_Pipe, tmpInterface)
    ...
    */
    it('release_interface_test_02', 0, function () {
    ...
    */
    it('release_interface_test_03', 0, function () {
    ...
    */
    it('release_interface_test_04', 0, function () {
    ...
    */
    it('release_interface_test_05', 0, function () {
    ...
    */
    it('set_interface_test_03', 0, function () {
        ...
        for (var j = 0; j < g_DeviceList[0].configs.length; j++) {
            var isClaimed = usb.claimInterface(g_Pipe, g_DeviceList[0].configs[j].interfaces[0], true);

            var tmpInterface = g_DeviceList[0].configs[j].interfaces[0]
            tmpInterface.protocol = 482
            var ret = usb.setInterface(g_Pipe, tmpInterface)
    ...
    */
    it('set_interface_test_04', 0, function () {
        ...
        for (var j = 0; j < g_DeviceList[0].configs.length; j++) {
            var isClaim = usb.claimInterface(g_Pipe, g_DeviceList[0].configs[j].interfaces[0], true)
    ...
    */
    it('set_interface_test_05', 0, function () {
    ...
    */
    it('set_interface_test_06', 0, function () {
        console.info('usb set_interface_test_05 begin');
        if (g_DeviceList.length == 0) {
            console.info('usb case get_device_list is null')
            expect(false).assertTrue()
    ...
    */
    it('set_configuration_test_03', 0, function () {
        ...
        for (var j = 0; j < g_DeviceList[0].configs.length; j++) {
            var config = g_DeviceList[0].configs[j]
            config.name = 'asdfsd'
            var ret = usb.setConfiguration(g_Pipe, config)
    ...
    * @tc.desc      : 反向测试 USBConfig的name 赋值错误 设置设备接口
    */
    it('set_configuration_test_04', 0, function () {
    ...
    */
    it('set_configuration_test_05', 0, function () {
